...
public interface LawyerRepository extends JpaRepository<Lawyer, Long> {
    ...
    @Query(nativeQuery = true, value = "(select name, customers_number AS customersNumber from lawyers WHERE customers_number = (SELECT MAX(customers_number) FROM LAWYERS)) " +
            "UNION ALL " +
